...
#ifndef RTW_HEADER_Act2_2_e_h_
#define RTW_HEADER_Act2_2_e_h_
#include <math.h>
#include <string.h>
#ifndef Act2_2_e_COMMON_INCLUDES_
#define Act2_2_e_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Act2_2_e_COMMON_INCLUDES_ */

#include "Act2_2_e_types.h"
...
#define Act2_2_e_rtModel               RT_MODEL_Act2_2_e_T

/* Block signals (default storage) */
typedef struct {
  real_T Vo;                           /* '<Root>/Integrator' */
  real_T Gain;                         /* '<Root>/Gain' */
  real_T Gain1;                        /* '<Root>/Gain1' */
  real_T Vo_e;                         /* '<Root>/Signal Generator' */
  real_T Vo_p;                         /* '<Root>/HIL Read Analog' */
} B_Act2_2_e_T;

/* Block states (default storage) for system '<Root>' */
typedef struct {
  real_T HILInitialize_AOVoltages;     /* '<Root>/HIL Initialize' */
  real_T Vo_Buffer;                    /* synthesized block */
...
#define rtB                            Act2_2_e_B
#define BlockIO                        B_Act2_2_e_T
#define rtX                            Act2_2_e_X
#define ContinuousStates               X_Act2_2_e_T
#define rtXdot                         Act2_2_e_XDot
#define StateDerivatives               XDot_Act2_2_e_T
#define tXdis                          Act2_2_e_XDis
#define StateDisabled                  XDis_Act2_2_e_T
#define rtP                            Act2_2_e_P
#define Parameters                     P_Act2_2_e_T
#define rtDWork                        Act2_2_e_DW
#define D_Work                         DW_Act2_2_e_T

/* Parameters (default storage) */
struct P_Act2_2_e_T_ {
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T Gain_Gain;                    /* Expression: 10e-4
                                        * Referenced by: '<Root>/Gain'
                                        */
  real_T Gain1_Gain;                   /* Expression: 21277
                                        * Referenced by: '<Root>/Gain1'
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: 2.5
  ...
  boolean_T HILWriteAnalog_Active;  /* Computed Parameter: HILWriteAnalog_Active
                                     * Referenced by: '<Root>/HIL Write Analog'
                                     */
  uint8_T ToHostFile1_file_name[15];   /* Expression: file_name_argument
                                        * Referenced by: '<Root>/To Host File1'
                                        */
  ...
  uint8_T ToHostFile1_FileFormat;  /* Computed Parameter: ToHostFile1_FileFormat
                                    * Referenced by: '<Root>/To Host File1'
                                    */
  uint8_T ToHostFile_file_name[17];    /* Expression: file_name_argument
                                        * Referenced by: '<Root>/To Host File'
                                        */
...
extern P_Act2_2_e_T Act2_2_e_P;

/* Block signals (default storage) */
extern B_Act2_2_e_T Act2_2_e_B;

/* Continuous states (default storage) */
extern X_Act2_2_e_T Act2_2_e_X;

/* Block states (default storage) */
extern DW_Act2_2_e_T Act2_2_e_DW;
...
extern void Act2_2_e_initialize(void);
extern void Act2_2_e_output0(void);
extern void Act2_2_e_update0(void);
extern void Act2_2_e_output2(void);
extern void Act2_2_e_update2(void);
extern void Act2_2_e_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Act2_2_e_rtModel *Act2_2_e(void);
...
extern RT_MODEL_Act2_2_e_T *const Act2_2_e_M;
