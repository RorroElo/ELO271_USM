###########################################################################
## Makefile generated for component 'Act2_2_e'. 
## 
## Makefile     : Act2_2_e.mk
## Generated on : Tue Apr 16 17:17:00 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Act2_2_e.rt-win64
...
COMPILER_COMMAND_FILE     = Act2_2_e_comp.rsp
CMD_FILE                  = Act2_2_e.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Act2_2_e.rt-win64
...
DEFINES_STANDARD = -DMODEL=Act2_2_e -DNUMST=3 -DNCSTATES=1 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e.c $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e_data.c $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e_main.c $(START_DIR)\Act2_2_e_quarc_win64\rtGetInf.c $(START_DIR)\Act2_2_e_quarc_win64\rtGetNaN.c $(START_DIR)\Act2_2_e_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Act2_2_e.obj Act2_2_e_data.obj Act2_2_e_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Act2_2_e_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Act2_2_e_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Act2_2_e.obj : $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e.c


Act2_2_e_data.obj : $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e_data.c


Act2_2_e_main.obj : $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act2_2_e_quarc_win64\Act2_2_e_main.c


rtGetInf.obj : $(START_DIR)\Act2_2_e_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act2_2_e_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Act2_2_e_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act2_2_e_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Act2_2_e_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act2_2_e_quarc_win64\rt_nonfinite.c
