    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% untitled_P.HILReadAnalog_channels
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% untitled_P.ToHostFile_Decimation
                    section.data(4).logicalSrcIdx = 22;
                    section.data(4).dtTransOffset = 3;

                    ;% untitled_P.ToHostFile_BitRate
                    section.data(5).logicalSrcIdx = 23;
                    section.data(5).dtTransOffset = 4;

                    ;% untitled_P.ToHostFile1_Decimation
                    section.data(6).logicalSrcIdx = 24;
                    section.data(6).dtTransOffset = 5;

                    ;% untitled_P.ToHostFile1_BitRate
            ...
            section.data(37)  = dumData; %prealloc
                    ...
                    ;% untitled_P.HILReadAnalog_Active
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% untitled_DW.HILReadAnalog_Buffer
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% untitled_DW.ToHostFile_PointsWritten
                    section.data(1).logicalSrcIdx = 2;
                    section.data(1).dtTransOffset = 0;

                    ;% untitled_DW.ToHostFile1_PointsWritten
                    section.data(2).logicalSrcIdx = 3;
                    section.data(2).dtTransOffset = 1;
            ...
            section.data(6)  = dumData; %prealloc
                    ...
                    ;% untitled_DW.HILReadAnalog_PWORK
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% untitled_DW.ToHostFile_SamplesCount
                    section.data(1).logicalSrcIdx = 11;
                    section.data(1).dtTransOffset = 0;

                    ;% untitled_DW.ToHostFile_ArrayNameLength
                    section.data(2).logicalSrcIdx = 12;
                    section.data(2).dtTransOffset = 1;

                    ;% untitled_DW.ToHostFile1_SamplesCount
                    section.data(3).logicalSrcIdx = 13;
                    section.data(3).dtTransOffset = 2;

                    ;% untitled_DW.ToHostFile1_ArrayNameLength
    ...
    targMap.checksum0 = 3378205392;
    targMap.checksum1 = 156639065;
    targMap.checksum2 = 252767236;
    targMap.checksum3 = 189893489;
