...
#ifndef RTW_HEADER_Act1_h_
#define RTW_HEADER_Act1_h_
#include <math.h>
#include <string.h>
#ifndef Act1_COMMON_INCLUDES_
#define Act1_COMMON_INCLUDES_
#include "rtwtypes.h"
...
#endif                                 /* Act1_COMMON_INCLUDES_ */

#include "Act1_types.h"
...
#define Act1_rtModel                   RT_MODEL_Act1_T
...
#define rtB                            Act1_B
#define BlockIO                        B_Act1_T
#define rtP                            Act1_P
#define Parameters                     P_Act1_T
#define rtDWork                        Act1_DW
#define D_Work                         DW_Act1_T
...
struct P_Act1_T_ {
  ...
  boolean_T HILWriteAnalog_Active;  /* Computed Parameter: HILWriteAnalog_Active
                                     * Referenced by: '<Root>/HIL Write Analog'
                                     */
  uint8_T ToHostFile_file_name[18];    /* Expression: file_name_argument
                                        * Referenced by: '<Root>/To Host File'
                                        */
  ...
  uint8_T ToHostFile_FileFormat;    /* Computed Parameter: ToHostFile_FileFormat
                                     * Referenced by: '<Root>/To Host File'
                                     */
  uint8_T ToHostFile1_file_name[16];   /* Expression: file_name_argument
                                        * Referenced by: '<Root>/To Host File1'
                                        */
...
extern P_Act1_T Act1_P;

/* Block signals (default storage) */
extern B_Act1_T Act1_B;

/* Block states (default storage) */
extern DW_Act1_T Act1_DW;

/* Model entry point functions */
extern void Act1_initialize(void);
extern void Act1_output(void);
extern void Act1_update(void);
extern void Act1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Act1_rtModel *Act1(void);
...
extern RT_MODEL_Act1_T *const Act1_M;
