###########################################################################
## Makefile generated for component 'Act1'. 
## 
## Makefile     : Act1.mk
## Generated on : Tue Apr 16 16:16:58 2024
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\Act1.rt-win64
...
COMPILER_COMMAND_FILE     = Act1_comp.rsp
CMD_FILE                  = Act1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\Act1.rt-win64
...
DEFINES_STANDARD = -DMODEL=Act1 -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\Act1_quarc_win64\Act1.c $(START_DIR)\Act1_quarc_win64\Act1_data.c $(START_DIR)\Act1_quarc_win64\Act1_main.c $(START_DIR)\Act1_quarc_win64\rtGetInf.c $(START_DIR)\Act1_quarc_win64\rtGetNaN.c $(START_DIR)\Act1_quarc_win64\rt_nonfinite.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = Act1.obj Act1_data.obj Act1_main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\Act1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\Act1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
Act1.obj : $(START_DIR)\Act1_quarc_win64\Act1.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act1_quarc_win64\Act1.c


Act1_data.obj : $(START_DIR)\Act1_quarc_win64\Act1_data.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act1_quarc_win64\Act1_data.c


Act1_main.obj : $(START_DIR)\Act1_quarc_win64\Act1_main.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act1_quarc_win64\Act1_main.c


rtGetInf.obj : $(START_DIR)\Act1_quarc_win64\rtGetInf.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act1_quarc_win64\rtGetInf.c


rtGetNaN.obj : $(START_DIR)\Act1_quarc_win64\rtGetNaN.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act1_quarc_win64\rtGetNaN.c


rt_nonfinite.obj : $(START_DIR)\Act1_quarc_win64\rt_nonfinite.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\Act1_quarc_win64\rt_nonfinite.c
